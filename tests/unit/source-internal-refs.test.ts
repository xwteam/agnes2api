 ...
 *      **今天射程内 51 处 / 8 份**：排版轴 18、`scripts/prepush.sh` 13、
 *      偏离名册 11，其余五份各 1 到 3 处。
 *      ⚠️ **这个数正在被清，别把它读成稳态**：对照轴那 64 处上一批清完了，
 *      而清它的是人，不是这份判据——它从头到尾一格没红。
