 ...
 * 实测：把 `/admin/api/models` 那一支改成返 500，`models` 从 61 掉到 7、`playground`
 * 从 27 掉到 7（两格当场红），而 `settings` 只从 117 掉到 106 —— **仍在 100 之上、这里不红**。
 * 那次故障是被 models / playground 两格抓住的，不是被这一格。别把这张表读成
 * 「每个板块的每一张卡都有人守」。
 *
