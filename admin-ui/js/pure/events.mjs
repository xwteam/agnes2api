 ...
 * **k≥3 全部超出 C4b 规划、五语言 DEPLOY.md 白纸黑字承诺的包线**。改成
 ...
 * **全部偏低 1,440**。
 * 这几个数字由 `tests/contract/events-cursor-heal.test.ts:224` 的"逐 k 实测稳态
 * 吞吐"用例逐个钉住（连同 70,560 基准线本身，`:269`），不是只写在这里。
 *
